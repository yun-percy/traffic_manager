...
public class CircleProgress extends View
{
    ...
    public void onDraw(Canvas canvas)
    {
        ...
        switch (type){
            case ARC:
                ...
                break;
            case SECTOR:
            	if(mSubCurProgress<50){
            		this.mCircleAttribute.mSubPaint.setColor(Color.parseColor("#22ac38"));
            	}
            	else if(mSubCurProgress>80 && mSubCurProgress<95){
            		this.mCircleAttribute.mSubPaint.setColor(Color.parseColor("#f19149"));
            	}
            	else if(mSubCurProgress>=95){
            		this.mCircleAttribute.mSubPaint.setColor(Color.parseColor("#e60012"));
            	}
            	else{
            	this.mCircleAttribute.mSubPaint.setColor(Color.parseColor("#00b7ef"));
            	}
    ...
    class CircleAttribute
    {
        ...
        public int mSubPaintColor = Color.parseColor("#00b7ef");
        public int mSubPaintroundColor = Color.parseColor("#22ac38");
        public int mBottomPaintColor=Color.parseColor("#00000000");
        public int mMainPaintColor=Color.parseColor("#00000000");
